"""
Django settings for micro_oms project.
...
WSGI_APPLICATION = 'micro_oms.wsgi.application'
...
MICRO_OMS_API_KEY = os.getenv('MICRO_OMS_API_KEY')
...
CELERY_BEAT_SCHEDULE = {
    'sync-shopify-orders-every-5-min': {
